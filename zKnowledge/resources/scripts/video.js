...
var ModalDialog = (function (_Component) {
  ...
  ModalDialog.prototype.description = function description() {
      var desc = this.options_.description || this.localize('Video playback error: Please close this window and open this presentation using an alternate browser - such as Google Chrome or Mozilla Firefox. We apologize for the inconvenience.');
